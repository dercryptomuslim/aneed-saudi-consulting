...
export const metadata: Metadata = {
  title: "Services | Aneed Ashraf",
  description: "English services page coming soon.",
};

export default function ServicesEnPlaceholder() {
  return (
          ...
          <div className="max-w-2xl mx-auto text-center bg-white border border-slate-200 rounded-2xl p-8 shadow-sm">
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              <Button asChild className="bg-slate-900 hover:bg-slate-800 text-white">
                <Link href="/services">View services in German</Link>
              </Button>
