...
export const metadata: Metadata = {
  title: "Privacy | Aneed Ashraf",
  description: "English privacy page coming soon.",
};

export default function PrivacyEnPlaceholder() {
  return (
          ...
          <div className="max-w-2xl mx-auto text-center bg-white border border-slate-200 rounded-2xl p-8 shadow-sm">
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              <Button asChild className="bg-slate-900 hover:bg-slate-800 text-white">
                <Link href="/datenschutz">View in German</Link>
              </Button>
