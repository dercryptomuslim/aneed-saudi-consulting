...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const keywordMap: Record<string, string[]> = {
    "familienzusammenfuehrung": ["Family Reunification Saudi Arabia", "Bring Family to Saudi Arabia", "Iqama Family Visa", "Family Residence Visa KSA", "Dependent Visa Saudi Arabia", "Spouse Visa Saudi Arabia"],
