...
export const metadata: Metadata = {
  ...
  description: "Aktuelle Beiträge zu Gründung, Leben und Investment in Saudi-Arabien. Echte Erfahrungswerte aus Medina.",
};
        ...
        <div className="container mx-auto px-4 lg:px-8">
          ...
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-lg text-slate-600">
              Keine Theorie. Hier teile ich meine Erfahrungen aus fast einem Jahrzehnt Unternehmertum in Saudi-Arabien.
            </p>
          </div>
